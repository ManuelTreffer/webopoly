...
<div class="inner">
    ...
    <div class="spielernamen">
        ...
        <br>
        <form action="../spielfeld/spielfeld2.php" method="get">
        ...
        switch ($spieleranzahl) {
            ...
            <div class="input-group-prepend">
                <span class="input-group-text" id="inputGroup-sizing-sm"><img src="../../images/emojis/1emoji.png" width="22px"> </span>
            </div>
        ...
        <br><input type="submit" value="Start" class="btn btn-danger"></input>';
            ...
            <div class="input-group-prepend">
                <span class="input-group-text" id="inputGroup-sizing-sm"><img src="../../images/emojis/2emoji.png" width="22px"> </span>
            </div>
...
-->
    ...
    <a href="../spieleranzahl/spieleranzahl.html" class="zurueck">Zurück</a>
</div>
